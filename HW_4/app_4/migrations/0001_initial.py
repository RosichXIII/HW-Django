    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_img', models.ImageField(blank=True, null=True, upload_to='imges_product/')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_4.customer')),
                ('products', models.ManyToManyField(to='app_4.product')),
            ],
        ),
    ]
